  ...
  (setq-default
   ...
   '(csv
     ...
     ( markdown
       ...
       markdown-live-preview-engine: 'vdm
       )
     ;; ----------------------------------------------------------------
...
values."
  ...
  (setq-default
   ...
   ;; If non nil output loading prasdogress in `*Messages*' buffer. (default nil)
